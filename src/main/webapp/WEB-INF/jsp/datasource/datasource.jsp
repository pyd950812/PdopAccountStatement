...
<form action="hello/downloadDatasourceExcle" method="post" name="selectForm" id="selectForm">
    <div id="selectJsp">
        <table width="100%" border="1" cellpadding="0" cellspacing="1"
            ...
            <tr>
                <td>数据源名称(单选):<div name="merchantName">
                    <c:forEach var="m" items="${datasourceList}" varStatus="index">
                        <input type="radio" name="datasourceId"   id="${m.id}" value="${m.id}"/>${m.name}
                    </c:forEach>
                </div></td>
